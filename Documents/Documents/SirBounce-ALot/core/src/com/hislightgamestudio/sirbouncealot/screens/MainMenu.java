...
public class MainMenu extends AbstractGameScreen {
    ...
    public void show() {
        ...
        play.addAction(sequence(alpha(0), delay(0.05f), fadeIn(0.25f), alpha(1, 0.5f)));
        settings.addAction(sequence(alpha(0), delay(0.15f), fadeIn(0.25f), alpha(1, 0.5f)));
        exit.addAction(sequence(alpha(0), delay(0.25f), fadeIn(0.25f), alpha(1, 0.5f)));
